...
from gi.repository import Gtk, Gdk, Pluma
import re
import os.path
#import pango
import shutil
...
CONFIG_DIR = os.path.expanduser('~/.local/share/pluma/plugins/' + APP_NAME + '/config')
...
class SmartHighlightWindowHelper:
	def __init__(self, plugin, window):
		...
		'''		
		user_configfile = os.path.join(os.path.expanduser('~/.local/share/pluma/plugins/' + 'smart_highlight'), 'config.xml')
